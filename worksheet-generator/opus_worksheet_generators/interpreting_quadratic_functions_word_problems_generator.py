"""
Interpreting Quadratic Functions (word problems) Generator
Unit 12.0
"""
...
class InterpretingQuadraticFunctionsWordProblemsGenerator:
    """Generates problems for Interpreting Quadratic Functions (word problems)."""
