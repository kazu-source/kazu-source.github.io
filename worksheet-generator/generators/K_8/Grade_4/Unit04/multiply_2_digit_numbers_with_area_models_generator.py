"""
Multiply 2-Digit Numbers with Area Models Generator - Grade 4 Unit 04
Generates problems on 2-digit by 2-digit using area models
...
class Multiply2DigitNumbersWithAreaModelsGenerator:
    """Generates 2-digit by 2-digit using area models problems."""
...
def main():
    """Test the generator."""
    generator = Multiply2DigitNumbersWithAreaModelsGenerator()
