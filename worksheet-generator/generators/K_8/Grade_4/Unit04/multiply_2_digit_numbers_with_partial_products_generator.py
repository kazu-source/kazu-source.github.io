"""
Multiply 2-Digit Numbers with Partial Products Generator - Grade 4 Unit 04
Generates problems on 2-digit multiplication with partial products
...
class Multiply2DigitNumbersWithPartialProductsGenerator:
    """Generates 2-digit multiplication with partial products problems."""
...
def main():
    """Test the generator."""
    generator = Multiply2DigitNumbersWithPartialProductsGenerator()
