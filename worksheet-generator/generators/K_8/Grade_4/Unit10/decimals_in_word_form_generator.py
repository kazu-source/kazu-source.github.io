"""
Decimals in Word Form Generator - Grade 4 Unit 10
Generates problems on reading and writing decimals in words
...
class DecimalsInWordFormGenerator:
    """Generates reading and writing decimals in words problems."""
...
def main():
    """Test the generator."""
    generator = DecimalsInWordFormGenerator()
