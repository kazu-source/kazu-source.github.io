"""
Comparing Decimals Visually Generator - Grade 4 Unit 10
Generates problems on visual comparison of decimals
...
class ComparingDecimalsVisuallyGenerator:
    """Generates visual comparison of decimals problems."""
...
def main():
    """Test the generator."""
    generator = ComparingDecimalsVisuallyGenerator()
