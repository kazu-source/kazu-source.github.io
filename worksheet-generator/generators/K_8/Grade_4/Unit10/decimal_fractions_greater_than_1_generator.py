"""
Decimal Fractions Greater than 1 Generator - Grade 4 Unit 10
Generates problems on decimals greater than one
...
class DecimalFractionsGreaterThan1Generator:
    """Generates decimals greater than one problems."""
...
def main():
    """Test the generator."""
    generator = DecimalFractionsGreaterThan1Generator()
