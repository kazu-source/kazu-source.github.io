"""
Writing Fractions as Decimals Generator - Grade 4 Unit 10
Generates problems on converting fractions to decimals
...
class WritingFractionsAsDecimalsGenerator:
    """Generates converting fractions to decimals problems."""
...
def main():
    """Test the generator."""
    generator = WritingFractionsAsDecimalsGenerator()
