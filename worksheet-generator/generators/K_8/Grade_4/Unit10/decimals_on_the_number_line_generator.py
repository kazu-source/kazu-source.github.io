"""
Decimals on the Number Line Generator - Grade 4 Unit 10
Generates problems on placing decimals on number lines
...
class DecimalsOnTheNumberLineGenerator:
    """Generates placing decimals on number lines problems."""
...
def main():
    """Test the generator."""
    generator = DecimalsOnTheNumberLineGenerator()
