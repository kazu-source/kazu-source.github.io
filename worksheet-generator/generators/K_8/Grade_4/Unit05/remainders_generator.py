"""
Remainders Generator - Grade 4 Unit 05
Generates problems on division with remainders
...
class RemaindersGenerator:
    """Generates division with remainders problems."""
