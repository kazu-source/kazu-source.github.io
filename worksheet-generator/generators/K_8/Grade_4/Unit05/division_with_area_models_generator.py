"""
Division with Area Models Generator - Grade 4 Unit 05
Generates problems on using area models for division
...
class DivisionWithAreaModelsGenerator:
    """Generates using area models for division problems."""
...
def main():
    """Test the generator."""
    generator = DivisionWithAreaModelsGenerator()
