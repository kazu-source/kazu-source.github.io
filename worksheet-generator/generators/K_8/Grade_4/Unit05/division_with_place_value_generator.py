"""
Division with Place Value Generator - Grade 4 Unit 05
Generates problems on using place value in division
...
class DivisionWithPlaceValueGenerator:
    """Generates using place value in division problems."""
...
def main():
    """Test the generator."""
    generator = DivisionWithPlaceValueGenerator()
