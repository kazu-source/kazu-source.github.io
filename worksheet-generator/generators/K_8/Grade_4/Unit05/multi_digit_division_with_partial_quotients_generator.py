"""
Multi-Digit Division with Partial Quotients Generator - Grade 4 Unit 05
Generates problems on using partial quotients method
...
class MultiDigitDivisionWithPartialQuotientsGenerator:
    """Generates using partial quotients method problems."""
...
def main():
    """Test the generator."""
    generator = MultiDigitDivisionWithPartialQuotientsGenerator()
