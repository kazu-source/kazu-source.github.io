"""
Comparing Fractions with Unlike Denominators Generator - Grade 4 Unit 07
Generates problems on comparing fractions with different denominators
...
class ComparingFractionsWithUnlikeDenominatorsGenerator:
    """Generates comparing fractions with different denominators problems."""
...
def main():
    """Test the generator."""
    generator = ComparingFractionsWithUnlikeDenominatorsGenerator()
