"""
Comparing Fractions with Unlike Denominators Visually Generator - Grade 4 Unit 07
Generates problems on visual fraction comparison
...
class ComparingFractionsWithUnlikeDenominatorsVisuallyGenerator:
    """Generates visual fraction comparison problems."""
...
def main():
    """Test the generator."""
    generator = ComparingFractionsWithUnlikeDenominatorsVisuallyGenerator()
