"""
Estimating Length Generator - Grade 4 Unit 14
Generates problems on estimating length/distance
...
class EstimatingLengthGenerator:
    """Generates estimating length/distance problems."""
...
def main():
    """Test the generator."""
    generator = EstimatingLengthGenerator()
