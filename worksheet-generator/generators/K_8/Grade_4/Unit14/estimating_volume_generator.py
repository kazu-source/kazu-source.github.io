"""
Estimating Volume Generator - Grade 4 Unit 14
Generates problems on estimating volume/capacity
...
class EstimatingVolumeGenerator:
    """Generates estimating volume/capacity problems."""
...
def main():
    """Test the generator."""
    generator = EstimatingVolumeGenerator()
