"""
Multi-Digit Multiplication: Place Value and Area Models Generator - Grade 4 Unit 03
Generates problems on using area models for multiplication
...
class MultiDigitMultiplicationPlaceValueAndAreaModelsGenerator:
    """Generates using area models for multiplication problems."""
...
def main():
    """Test the generator."""
    generator = MultiDigitMultiplicationPlaceValueAndAreaModelsGenerator()
