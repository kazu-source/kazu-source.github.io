"""
Comparing with Multiplication Generator - Grade 4 Unit 03
Generates problems on comparing quantities using multiplication
...
class ComparingWithMultiplicationGenerator:
    """Generates comparing quantities using multiplication problems."""
...
def main():
    """Test the generator."""
    generator = ComparingWithMultiplicationGenerator()
