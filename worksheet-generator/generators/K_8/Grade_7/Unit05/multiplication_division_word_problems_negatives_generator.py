'''
Mult Div Word Problems Generator - Grade 7 Unit05
'''
...
class MultiplicationDivisionWordProblemsNegativesGenerator:
...
def main():
    generator = MultiplicationDivisionWordProblemsNegativesGenerator()
