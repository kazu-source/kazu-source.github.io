'''
Fraction Operations Generator - Grade 7 Unit05
'''
...
class UnderstandingMultiplyingDividingFractionsGenerator:
...
def main():
    generator = UnderstandingMultiplyingDividingFractionsGenerator()
