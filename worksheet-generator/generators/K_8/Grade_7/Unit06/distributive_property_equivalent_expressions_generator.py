'''
Distributive Property Generator - Grade 7 Unit06
'''
...
class DistributivePropertyEquivalentExpressionsGenerator:
...
def main():
    generator = DistributivePropertyEquivalentExpressionsGenerator()
