'''
Subtracting Negatives Fluent Generator - Grade 7 Unit03
'''
...
class SubtractingNegativeNumbersFluentlyGenerator:
...
def main():
    generator = SubtractingNegativeNumbersFluentlyGenerator()
