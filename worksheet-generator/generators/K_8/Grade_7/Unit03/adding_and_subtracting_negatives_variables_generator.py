'''
Negatives With Variables Generator - Grade 7 Unit03
'''
...
class AddingAndSubtractingNegativesVariablesGenerator:
...
def main():
    generator = AddingAndSubtractingNegativesVariablesGenerator()
