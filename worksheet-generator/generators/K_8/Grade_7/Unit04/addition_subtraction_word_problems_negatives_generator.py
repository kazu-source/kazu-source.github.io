'''
Word Problems Negatives Generator - Grade 7 Unit04
'''
...
class AdditionSubtractionWordProblemsNegativesGenerator:
...
def main():
    generator = AdditionSubtractionWordProblemsNegativesGenerator()
