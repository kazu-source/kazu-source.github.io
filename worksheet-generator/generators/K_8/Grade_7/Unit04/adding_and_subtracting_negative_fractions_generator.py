'''
Negative Fractions Generator - Grade 7 Unit04
'''
...
class AddingAndSubtractingNegativeFractionsGenerator:
...
def main():
    generator = AddingAndSubtractingNegativeFractionsGenerator()
