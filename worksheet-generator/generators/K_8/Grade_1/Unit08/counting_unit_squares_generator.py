"""
Counting Unit Squares Generator - Grade 1 Unit08
Generates counting unit squares problems
...
class CountingUnitSquaresGenerator:
    """Generates counting unit squares problems."""
...
def main():
    generator = CountingUnitSquaresGenerator()
    print("Problems:")
