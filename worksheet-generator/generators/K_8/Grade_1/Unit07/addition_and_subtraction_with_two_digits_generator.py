"""
Addition And Subtraction With Two Digits Generator - Grade 1 Unit07
Generates addition and subtraction with two digits problems
...
class AdditionAndSubtractionWithTwoDigitsGenerator:
    """Generates addition and subtraction with two digits problems."""
...
def main():
    generator = AdditionAndSubtractionWithTwoDigitsGenerator()
    print("Problems:")
