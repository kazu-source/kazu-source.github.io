"""
Telling Time Hour And Half Hour Generator - Grade 1 Unit09
Generates telling time hour and half hour problems
"""
...
class TellingTimeHourHalfHourGenerator:
    """Generates telling time hour and half hour problems."""
...
def main():
    generator = TellingTimeHourHalfHourGenerator()
    print("Easy:")
