"""
Reading Picture Graphs Generator - Grade 1 Unit10
Generates reading picture graphs problems
...
class ReadingPictureGraphsGenerator:
    """Generates reading picture graphs problems."""
...
def main():
    generator = ReadingPictureGraphsGenerator()
    print("Problems:")
