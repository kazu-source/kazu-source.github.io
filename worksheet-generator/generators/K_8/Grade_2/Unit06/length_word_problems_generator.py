"""
Length Word Problems Generator - Grade 2 Unit06
Generates length word problems problems
"""
...
class LengthWordProblemsGenerator:
    """Generates length word problems problems."""
...
def main():
    generator = LengthWordProblemsGenerator()
    print("Easy:")
