"""
Comparing 2 And 3 Digit Numbers Generator - Grade 2 Unit02
Generates comparing 2 and 3 digit numbers problems
...
class Comparing2And3DigitNumbersGenerator:
    """Generates comparing 2 and 3 digit numbers problems."""
...
def main():
    generator = Comparing2And3DigitNumbersGenerator()
    print("Problems:")
