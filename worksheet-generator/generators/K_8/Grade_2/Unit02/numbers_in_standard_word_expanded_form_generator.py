"""
Numbers In Standard Word Expanded Form Generator - Grade 2 Unit02
Generates numbers in standard word expanded form problems
...
class NumbersInStandardWordExpandedFormGenerator:
    """Generates numbers in standard word expanded form problems."""
...
def main():
    generator = NumbersInStandardWordExpandedFormGenerator()
    print("Problems:")
