"""
Regroup Whole Numbers Generator - Grade 2 Unit02
Generates regroup whole numbers problems
...
class RegroupWholeNumbersGenerator:
    """Generates regroup whole numbers problems."""
...
def main():
    generator = RegroupWholeNumbersGenerator()
    print("Problems:")
