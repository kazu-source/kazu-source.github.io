"""
Partition Rectangles Generator - Grade 2 Unit08
Generates partition rectangles problems
...
class PartitionRectanglesGenerator:
    """Generates partition rectangles problems."""
...
def main():
    generator = PartitionRectanglesGenerator()
    print("Problems:")
