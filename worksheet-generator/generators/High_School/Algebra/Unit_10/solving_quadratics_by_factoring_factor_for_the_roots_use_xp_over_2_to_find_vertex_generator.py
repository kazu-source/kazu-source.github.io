"""
Solving Quadratics by Factoring (factor for the roots, use (x+p)/2 to find vertex) Generator
Unit 10.0
"""
...
class SolvingQuadraticsByFactoringFactorForTheRootsUseXPlusPOver2ToFindVertexGenerator:
    """Generates problems for Solving Quadratics by Factoring (factor for the roots, use (x+p)/2 to find vertex)."""
