"""
Functions (what is the point vs an equation, function notation) Generator
Unit 6.0
"""
...
class FunctionsWhatIsThePointVsAnEquationFunctionNotationGenerator:
    """Generates problems for Functions (what is the point vs an equation, function notation)."""
