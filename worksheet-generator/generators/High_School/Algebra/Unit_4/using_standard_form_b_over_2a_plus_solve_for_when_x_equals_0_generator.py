"""
Using Standard Form (-b/2a + solve for when x = 0) Generator
Unit 10.0
"""
...
class UsingStandardFormBOver2aPlusSolveForWhenXEquals0Generator:
    """Generates problems for Using Standard Form (-b/2a + solve for when x = 0)."""
