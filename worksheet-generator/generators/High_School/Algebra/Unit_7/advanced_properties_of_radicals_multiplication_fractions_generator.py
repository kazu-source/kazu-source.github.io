"""
Advanced Properties of Radicals (multiplication, fractions) Generator
Unit 7.0
"""
...
class AdvancedPropertiesOfRadicalsMultiplicationFractionsGenerator:
    """Generates problems for Advanced Properties of Radicals (multiplication, fractions)."""
