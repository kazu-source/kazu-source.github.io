"""
Quadratic Formula (hard to use the three main methods and completing the square) Generator
Unit 11.0
"""
...
class QuadraticFormulaHardToUseTheThreeMainMethodsAndCompletingTheSquareGenerator:
    """Generates problems for Quadratic Formula (hard to use the three main methods and completing the square)."""
