"""
Parts of a Term (recognizing that coefficients are multiplication) Generator
Unit 1.0
"""
...
class PartsOfATermRecognizingThatCoefficientsAreMultiplicationGenerator:
    """Generates problems for Parts of a Term (recognizing that coefficients are multiplication)."""
