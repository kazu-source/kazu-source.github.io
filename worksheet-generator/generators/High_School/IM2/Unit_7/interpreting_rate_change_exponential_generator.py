# -*- coding: utf-8 -*-
"""
Interpreting Rate of Change in Exponential Functions Generator
"""
import random
...
class InterpretingRateChangeExponentialGenerator:
...
def main():
    gen = InterpretingRateChangeExponentialGenerator()
